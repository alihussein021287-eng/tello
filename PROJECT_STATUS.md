...
## 📱 ضبط الموبايل الكامل (2026-06-16) — مُختبَر ✓
- الإشعارات: responsive كامل (تنحصر بالشاشة + تمرير + backdrop) — كانت مقصوصة
- نافذة عقار جديد: متجاوبة (items-start + هوامش موبايل)
- رأس لوحة المالك: عمودي بالموبايل (flex-col sm:flex-row) + أزرار flex-wrap
- أزرار حجوزات المالك: flex-wrap (تتكسّر بدل ما تنقص)
- شريط الحجوزات: معلومات المستخدم flex-shrink-0
